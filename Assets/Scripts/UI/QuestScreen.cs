...
namespace Unity.DotsUISample
{
    ...
    public class QuestScreen : UIScreen
    {
        ...
        public static QuestScreen Instantiate(VisualElement parentElement) {
            var screen = CreateInstance<QuestScreen>();
        ...
        public void SetQuestData(QuestData questData, DynamicBuffer<CollectableCount> buf,
            CollectablesData collectables) {
            m_QuestData = questData;
            var titleLabel = new Label(m_QuestData.Title.ToUpper());
        ...
        public void UpdateMessage(DynamicBuffer<CollectableCount> buf, CollectablesData collectables,
            bool hasAllItems) {
            if (hasAllItems) {
