...
namespace Unity.DotsUISample
{
    ...
    public partial struct PlayerMovementSystem : ISystem
    {
        ...
        public void OnUpdate(ref SystemState state) {
            ...
            if (gameData.State != GameState.Questing) return;
            ...
            foreach (var (player, playerTransform, velocity) in
                ...
                if (math.lengthsq(playerMovement) > 0.01f) {
                    var moveDirection = math.normalizesafe(new float3(playerMovement.x, 0, playerMovement.y));
                    ...
                    velocity.ValueRW.Linear =
                        math.lerp(velocity.ValueRO.Linear, float3.zero, 10f * SystemAPI.Time.DeltaTime);
                }
