...
namespace Unity.DotsUISample
{
    ...
    internal sealed class PanelRendererUiRootSource : MonoBehaviour
    {
        public VisualElement RootElement { get; private set; }

        PanelRenderer _panelRenderer; //Migrated to use PanelRenderer because of Unity's plans of deprecating UIDocument component
    ...
    public partial struct GameManagerSystem : ISystem
    {
        ...
        public void OnUpdate(ref SystemState state) {
            ...
            if (game.ValueRO.State == GameState.Init) {
                ...
                var rootSource = Object.FindAnyObjectByType<PanelRendererUiRootSource>();
                if (rootSource == null) {
                    var panelRenderer = Object.FindAnyObjectByType<PanelRenderer>();
                    if (panelRenderer == null)
                        return;

                    rootSource = panelRenderer.gameObject.AddComponent<PanelRendererUiRootSource>();
                }
