...
namespace Unity.DotsUISample
{
    ...
    public partial struct CameraFollowSystem : ISystem
    {
        ...
        public void OnUpdate(ref SystemState state) {
            ...
            if (!cameraRef.Camera.IsValid()) return;
            ...
            foreach (var playerTransform in
                ...
                float t = math.saturate(1f - math.exp(-sharpness * SystemAPI.Time.DeltaTime));

                camera.transform.position = math.lerp(camera.transform.position, targetPos, t);
            }
        }
    }
    */
